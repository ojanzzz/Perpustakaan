...
- Architecture, ERD, routes, schema, risks → `docs/ARCHITECTURE.md`
- Full functional requirements → `Requitment.txt`
- Phase 1 implementation → identity, authentication, permission engine, migrations, seeds
- Phase 2 → content administration and PDF ingestion
- Phase 3 → public portal and search (implemented and verified)
- Phase 4 → reader and sharing
